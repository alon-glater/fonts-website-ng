...
export default function FontUpdateForm(props) {
  const {
    id: idProp,
    font: fontModelProp,
    onSuccess,
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Font, idProp)
        : fontModelProp;
      setFontRecord(record);
    };
    queryData();
  }, [idProp, fontModelProp]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Font.copyOf(fontRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "FontUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || fontModelProp)}
